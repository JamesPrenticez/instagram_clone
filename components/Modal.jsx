...
function Modal() {
    ...
    const uploadPost = async () => {
        ...
        // 3) upload the image to firbase storage with the post ID
        // 4) get download URL for firebase storage and update the original post with image
    ...
    return (
        <Transition.Root show={open} as={Fragment}>
            ...
            <div className="flex items-end justify-center min-h-[800px] sm:min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                ...
                {/* This element is to trick the browder in centering the modal contents */}
                <span 
                ...
                <Transition.Child
                    as={Fragment}
                    enter="ease-out duration-300"
                    entersFrom="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95"
